...
//   iconLG.classList.toggle("rotate-[270deg]");
//   iconLG.classList.toggle("animate-[rotate_.3s_linear_1]");
//   setTimeout(() => {
//     footerLG.classList.toggle("animate-[heightLG2_.3s_ease-in-out_1]");
//     footerLG.classList.toggle("animate-[heightLG_.3s_ease-in-out_1]");
...
//   iconLG.classList.toggle("animate-[rotateLG_.3s_ease-in-out_1]");
//   iconLG.classList.toggle("rotate-[270deg]");
//   setTimeout(() => {
//     if (footerLG.classList.contains("animate-[heightLG2_.3s_ease-in-out_1]")) {
//       footerLG.classList.toggle("animate-[heightLG2_.3s_ease-in-out_1]");
//     }
//     footerLG.classList.toggle("animate-[heightLG_.3s_ease-in-out_1]");
//   }, 300);
